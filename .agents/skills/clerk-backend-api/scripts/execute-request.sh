...
# Callers must export CLERK_SECRET_KEY and, for writes, CLERK_BAPI_SCOPES.
# Do not source project .env files here: they are shell input and may contain
# executable commands rather than literal environment assignments.
